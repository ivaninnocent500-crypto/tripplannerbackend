...
@property
def from_destination_id(self) -> str:
    """
    Compatibility accessor for downstream itinerary engines.

    The authoritative destination identity remains the RouteStop
    attached to this leg.
    """
    return self.from_stop.destination_id

@property
def to_destination_id(self) -> str:
    """
    Compatibility accessor for downstream itinerary engines.
    ...
    attached to this leg.
    """
    return self.to_stop.destination_id
...
def _assert_route_order(
    ...
    for index, leg in enumerate(analysis.legs):
        ...
        actual_from = leg.from_destination_id
        actual_to = leg.to_destination_id
